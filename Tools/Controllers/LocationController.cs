...
namespace Tools.Controllers
{
    public class LocationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Latitude,Longitude,CountryCode")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Latitude,Longitude,CountryCode")] Location location)
        {
            if (id != location.ID)
            {
                return NotFound();
